...
const LoginSelectors = require('../e2e/constants/loginSelectors');
const loginDetails = require('../e2e/constants/loginDetails');
...
test.describe('Login functionality tests', () => {
  ...
  test('Login form UI elements', async ({ page }) => {
    ...
    await expect(selectors.usernameInput).toHaveScreenshot('login-username-input.png', {
      fullPage: false,
      maxDiffPixels: 100,
      threshold: 0.3,
      animations: 'disabled',
    ...
    await expect(selectors.submitButton).toHaveScreenshot('login-submit-button.png', {
      fullPage: false,
      maxDiffPixels: 100,
      threshold: 0.3,
      animations: 'disabled',
    ...
    await selectors.usernameInput.fill(loginDetails.LOGIN_EMAIL);
